...
foreach ($key in $defaultFormState.Keys) { $script:currentFormState[$key] = $defaultFormState[$key] }
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Checklist"
        Height="900" Width="360" MinWidth="360"
  ...
  <Window.Resources>
    ...
    <Color x:Key="SubtleText">#FF4E4A4A</Color>
    <Color x:Key="OutlineColor">#FF7B7474</Color>
    <Color x:Key="Divider">#FFE3E0E0</Color>

    <Color x:Key="ChipBlueContainer">#FFCDEEE9</Color>
    <Color x:Key="OnChipBlueContainer">#FF134742</Color>

    <Color x:Key="ChipYellowContainer">#FFFFE8A3</Color>
    <Color x:Key="OnChipYellowContainer">#FF2A2200</Color>

    <Color x:Key="ChipRedContainer">#FFFFDAD6</Color>
    <Color x:Key="OnChipRedContainer">#FF410002</Color>

    <Color x:Key="ChipStoppedContainer">#FFE6E8E8</Color>
    <Color x:Key="OnChipStoppedContainer">#FF3D3A3A</Color>
    ...
    <SolidColorBrush x:Key="DropBgBrush" Color="#FFE7F6F3"/>
    ...
    <SolidColorBrush x:Key="ChipBlueBackgroundBrush" Color="{StaticResource ChipBlueContainer}"/>
    <SolidColorBrush x:Key="ChipBlueForegroundBrush" Color="{StaticResource OnChipBlueContainer}"/>
    <SolidColorBrush x:Key="ChipYellowBackgroundBrush" Color="{StaticResource ChipYellowContainer}"/>
    <SolidColorBrush x:Key="ChipYellowForegroundBrush" Color="{StaticResource OnChipYellowContainer}"/>
    <SolidColorBrush x:Key="ChipRedBackgroundBrush" Color="{StaticResource ChipRedContainer}"/>
    <SolidColorBrush x:Key="ChipRedForegroundBrush" Color="{StaticResource OnChipRedContainer}"/>
    <SolidColorBrush x:Key="ChipStoppedBackgroundBrush" Color="{StaticResource ChipStoppedContainer}"/>
    <SolidColorBrush x:Key="ChipStoppedForegroundBrush" Color="{StaticResource OnChipStoppedContainer}"/>
      ...
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="ComboBoxItem">
            <Border x:Name="ContainerBorder" CornerRadius="4" Background="Transparent" Margin="2,2" SnapsToDevicePixels="True">
              <Grid>
                <ContentPresenter VerticalAlignment="Center"/>
                <Border Height="1" VerticalAlignment="Bottom" Background="{StaticResource DropSeparatorBrush}" Opacity="0.08"/>
              </Grid>
            </Border>
          ...
          <ControlTemplate TargetType="ComboBox">
            <Grid>
              ...
              <Popup x:Name="PART_Popup" AllowsTransparency="True" Placement="Bottom"
                ...
                <Border Background="{StaticResource DropBgBrush}" BorderThickness="0" CornerRadius="4" Padding="6"
                        ClipToBounds="True" Width="{Binding ActualWidth, RelativeSource={RelativeSource TemplatedParent}}">
                  <Border.Effect><DropShadowEffect BlurRadius="22" ShadowDepth="8" Opacity="0.28"/></Border.Effect>
                  <ScrollViewer CanContentScroll="True"
                                VerticalScrollBarVisibility="Hidden"
                                HorizontalScrollBarVisibility="Disabled"
                                MaxHeight="320"
                                Background="{StaticResource DropBgBrush}">
                    <Border Background="{StaticResource DropBgBrush}" CornerRadius="4" ClipToBounds="True">
                      <ItemsPresenter/>
                    </Border>
                  </ScrollViewer>
                </Border>
          ...
          <ControlTemplate TargetType="TextBox">
            <Grid>
              ...
              <Border x:Name="TextBorder" Margin="0,10,0,0" CornerRadius="4"
                ...
                <ScrollViewer x:Name="PART_ContentHost" Margin="0" VerticalScrollBarVisibility="Hidden" HorizontalScrollBarVisibility="Disabled"/>
              </Border>
            </Grid>
...
foreach ($definition in $formFieldDefinitions) { Attach-EnterKeyToMoveNext -control ($mainWindow.FindName($definition.ControlName)) }
...
$mainWindow.Add_Loaded({ try { Set-WindowBottomLeft -window $mainWindow } catch {} }) | Out-Null
